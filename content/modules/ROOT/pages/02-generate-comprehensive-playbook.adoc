...
. The automationcoding assistant will generate the playbook and show you a preview with suggested tasks. *Review the suggested steps* to confirm they match your prompt, then click *"Create Playbook"* to manually confirm and create the file.
