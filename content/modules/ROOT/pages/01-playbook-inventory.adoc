...
[TIP]
====
The Ansible extension and its automation coding assistant are pre-configured in this lab to use a *LiteMaaS* model endpoint — Red Hat AI's Model-as-a-Service platform. You do not need to log in, authenticate, or provide any credentials; everything is already set up for you.
====
=====
======
